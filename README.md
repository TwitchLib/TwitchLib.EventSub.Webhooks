...
| :--------------- | ----: | :--------------------------------------------------------------------------- |
| Package Manager  | `PM>` | `Install-Package TwitchLib.EventSub.Webhooks -Version 2.2.0`                 |
| .NET CLI         | `>`   | `dotnet add package TwitchLib.EventSub.Webhooks --version 2.2.0`             |
| PackageReference |       | `<PackageReference Include="TwitchLib.EventSub.Webhooks" Version="2.2.0" />` |
| Paket CLI        | `>`   | `paket add TwitchLib.EventSub.Webhooks --version 2.2.0`                      |
